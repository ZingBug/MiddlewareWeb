...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-4">
            <label class="control-label">请输入病人姓名</label>
            <div>
                <input class="form-control col-sm-3" style="text" id="name" placeholder="name" required>
            </div>
        </div>
        <div class="col-sm-3">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#query').click(function () {
            ...
            $.ajax({
                type:"GET",
                url:"/query/"+cur_device+"/"+"sampleByName?"+"name="+name,
                dataType:"json",
