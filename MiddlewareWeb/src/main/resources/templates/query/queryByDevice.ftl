...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-4">
            <label class="control-label">选择具体仪器型号：</label>
            <select class="form-control col-sm-3" id="deviceModel" onclick="loadDevice()">
            </select>
        </div>
        <div class="col-sm-3">
...
<script type="text/javascript">
    ...
    function loadDevice() {
        ...
        var slv=$('#deviceModel').val();
        $('#deviceModel').empty();
        $.ajax({
            type:"GET",
            url:"/query/"+cur_device+"/device",
            dataType:"json",
            ...
            success:function (data) {
                for(var key in data)
                {
                    ...
                    {
                        $('#deviceModel').append('<option value="'+ key +'">' + key + '</option>');
                        $('#deviceModel').val(slv);
                    }
                }
            },
    ...
    $(function () {
        ...
        $('#query').click(function () {
            ...
            $.ajax({
                type:"GET",
                url:"/query/"+cur_device+"/"+"sampleByDevice?"+"device="+device,
                dataType:"json",
                contentType:"charset=utf-8",
